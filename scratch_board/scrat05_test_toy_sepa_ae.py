import torch as tt
from module.ToySeparateAE import Identity, Coder, ToySeparableAE
...
ae = ToySeparableAE(ae_id=desc, lr=1e-5)
print(ae)
ae.cuda()
ds = STL10()
...
for epoch in range(100):
    for ii, xs in enumerate(dl):
        ...
        if epoch < 50:
            ...
            loss_quality, loss_sparsity = ae.step(var_train_img, lamb_sparsity=5e-6)
